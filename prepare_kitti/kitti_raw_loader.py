...
class KittiRawLoader(object):
    ...
    def get_scene_imgs(self, scene_data):
        ...
        if self.from_speed:
            ...
            for i, (speed1, speed2, t1, t2) in enumerate(zip(scene_data['speed'][1:],
                ...
                print(f"\riter:{i}/{len(scene_data['speed'][1:])}", end="")
    ...
    def load_image(self, scene_data, tgt_idx):
        img_file = scene_data['dir'] / 'image_{}'.format(scene_data['cid']) / 'data' / scene_data['frame_id'][
            tgt_idx] + '.png'
    ...
    def get_depth_map(self, scene_data, tgt_idx):
        ...
        velo_file_name = scene_data['dir'] / 'velodyne_points' / 'data' / '{}.bin'.format(
