...
if __name__=='__main__':
    ...
    config={
        ...
        'mapping': {'sample': 2048, 'first_mesh': True, 'iters': 20, 'cur_frame_iters': 0, 'lr_embed': 0.01,
                 ...
                 'n_pixels': 0.05, 'first_iters': 1000, 'optim_cur': True, 'min_pixels_cur': 100, 'map_accum_step': 1,
        ...
        'decoder': {'geo_feat_dim': 15, 'hidden_dim': 32, 'num_layers': 2, 'num_layers_color': 2, 'hidden_dim_color': 32,
                 'tcnn_network': False},
        ...
        'training': {'rgb_weight': 1.0, 'depth_weight': 0.1, 'sdf_weight': 5000, 'fs_weight': 10, 'eikonal_weight': 0,
                  'smooth_weight': 1e-08, 'smooth_pts': 64, 'smooth_vox': 0.04, 'smooth_margin': 0.0, 'n_samples_d': 64,
                  'range_d': 0.25, 'n_range_d': 21, 'n_importance': 0, 'perturb': 1, 'white_bkgd': False, 'trunc': 0.05,
    ...
    model = ColorSDFNet_v2(config, input_ch=32, input_ch_pos=48)
    # embed_pos: [174080,48]
    # embed: [174080,32]
